...
export default function DashboardLayout({ children }: Props) {
  ...
  const navigation = [
    ...
    { name: 'Calendar', href: '/staff/calendar', icon: '🗓️' },
    { name: 'Customers', href: '/staff/customers', icon: '👥' },
    { name: 'Pets', href: '/staff/pets', icon: '🐾' },
    { name: 'Services', href: '/staff/services', icon: '✂️' },
    { name: 'Staff', href: '/staff/team', icon: '👨‍💼' },
    { name: 'Reports', href: '/staff/reports', icon: '📈' },
    { name: 'Settings', href: '/staff/settings', icon: '⚙️' },
  ];
