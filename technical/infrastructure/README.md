...
This directory contains all infrastructure, deployment, and operations documentation for saas202512.
...
- Add secrets to: `https://github.com/YOUR_ORG/saas202512/settings/secrets/actions`
...
|-------------|---------|-----|-------------|
| **Development** | Local machine | localhost:3012 | Manual |
| **Staging** | Testing/QA | saas202512-staging.azurecontainerapps.io | On push to `develop` |
| **Production** | Live users | saas202512.azurecontainerapps.io | On release tag |
