...
1. Go to: `https://github.com/YOUR_ORG/saas202512/settings/secrets/actions`
...
# Check: https://github.com/YOUR_ORG/saas202512/actions
```

**Staging will be live at:** `https://saas202512-staging.azurecontainerapps.io`
...
**Production will be live at:** `https://saas202512.azurecontainerapps.io`

---

## Azure Resources Created

### Resource Group: `saas202512-rg`

All resources are organized in one resource group for easy management.

### Container Registry: `saas202512acr`

**Purpose:** Stores Docker images
**SKU:** Basic (upgradeable to Standard/Premium)
**URL:** `saas202512acr.azurecr.io`

### Container Apps Environment: `saas202512-env`
...
1. **saas202512-staging** (staging environment)
   - URL: `https://saas202512-staging.azurecontainerapps.io`
   - Min replicas: 1, Max replicas: 3
   - Auto-deploys on push to `develop` branch

2. **saas202512-prod** (production environment)
   - URL: `https://saas202512.azurecontainerapps.io`
   - Min replicas: 2, Max replicas: 10
   - Deploys on release tags only

### PostgreSQL Flexible Server: `saas202512-db`
...
**Databases:**
- `saas202512_staging` - Staging environment
- `saas202512_production` - Production environment

### Redis Cache: `saas202512-redis`
...
### Blob Storage: `saas202512storage`
...
az keyvault secret show \
  --vault-name saas202512-kv \
  --name DATABASE-URL-PRODUCTION \
  --query value -o tsv

# Connect with psql
psql "postgresql://username:password@saas202512-db.postgres.database.azure.com:5432/saas202512_production?sslmode=require"
```
...
2. Find your Container App: `saas202512-prod`
...
az containerapp logs show \
  --name saas202512-staging \
  --resource-group saas202512-rg \
  --follow

# Stream logs (production)
az containerapp logs show \
  --name saas202512-prod \
  --resource-group saas202512-rg \
  --follow
```
...
az monitor metrics alert create \
  ...
  --resource-group saas202512-rg \
  --scopes /subscriptions/{sub-id}/resourceGroups/saas202512-rg/providers/Microsoft.App/containerApps/saas202512-prod \
...
```
https://github.com/YOUR_ORG/saas202512/actions
```
...
az monitor metrics list \
  --resource /subscriptions/{sub-id}/resourceGroups/saas202512-rg/providers/Microsoft.App/containerApps/saas202512-prod \
...
az postgres flexible-server restore \
  --resource-group saas202512-rg \
  --name saas202512-db-restored \
  --source-server saas202512-db \
...
az containerapp revision activate \
  --name saas202512-prod \
  --resource-group saas202512-rg \
  --revision saas202512-prod--previous-revision
```
...
- **Project Repository**: https://github.com/ChrisStephens1971/saas202512
