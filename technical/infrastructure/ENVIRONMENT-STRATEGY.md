...
| **URL** | localhost:3012 | staging.azurecontainerapps.io | azurecontainerapps.io |
...
DEBUG=true
DATABASE_URL=postgresql://localhost:5412/saas202512
...
NODE_ENV=staging
DEBUG=true
DATABASE_URL=postgresql://saas202512-db.postgres.database.azure.com/saas202512_staging
REDIS_URL=rediss://saas202512-redis.redis.cache.windows.net:6380
FRONTEND_URL=https://saas202512-staging.azurecontainerapps.io
CORS_ORIGINS=https://saas202512-staging.azurecontainerapps.io
```
...
NODE_ENV=production
DEBUG=false
DATABASE_URL=postgresql://saas202512-db.postgres.database.azure.com/saas202512_production
REDIS_URL=rediss://saas202512-redis.redis.cache.windows.net:6380
FRONTEND_URL=https://saas202512.azurecontainerapps.io
CORS_ORIGINS=https://saas202512.azurecontainerapps.io,https://yourdomain.com
```
...
STAGING_URL=https://saas202512-staging.azurecontainerapps.io npm run test:e2e
```
