...
az ad sp create-for-rbac \
  --name "saas202512-github-actions" \
  --role contributor \
  --scopes /subscriptions/{SUBSCRIPTION_ID}/resourceGroups/saas202512-rg \
  --sdk-auth
...
1. Go to: `https://github.com/YOUR_ORG/saas202512/settings/actions`
...
# Or use GitHub UI:
# https://github.com/YOUR_ORG/saas202512/releases/new
```
...
```markdown
![CI](https://github.com/YOUR_ORG/saas202512/workflows/CI/badge.svg)
![Deploy Staging](https://github.com/YOUR_ORG/saas202512/workflows/Deploy%20Staging/badge.svg)
![Deploy Production](https://github.com/YOUR_ORG/saas202512/workflows/Deploy%20Production/badge.svg)
```
...
2. Check Service Principal hasn't expired:
   ```bash
   az ad sp list --display-name "saas202512-github-actions"
   ```
...
# Test Docker build
docker build -t saas202512:test .
docker run -p 8000:8000 saas202512:test
```
